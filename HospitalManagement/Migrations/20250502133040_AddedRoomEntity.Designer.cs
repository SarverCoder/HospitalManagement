...
namespace HospitalManagement.Migrations
{
    ...
    [Migration("20250502133040_AddedRoomEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalManagement.DataAccess.Entities.Patient", b =>
                {
                    ...
                    b.HasIndex("PatientBlankId")
                        .IsUnique()
                        .HasDatabaseName("ix_patients_patient_blank_id");
            ...
            modelBuilder.Entity("HospitalManagement.DataAccess.Entities.Room", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("HospitalManagement.DataAccess.Entities.Appointment", b =>
                {
                    ...
                    b.HasOne("HospitalManagement.DataAccess.Entities.Room", null)
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("HospitalManagement.DataAccess.Entities.Patient", b =>
                {
                    b.HasOne("HospitalManagement.DataAccess.Entities.PatientBlank", "PatientBlank")
                        .WithOne("Patient")
                        .HasForeignKey("HospitalManagement.DataAccess.Entities.Patient", "PatientBlankId")
                        .HasConstraintName("fk_patients_patient_blanks_patient_blank_id");
